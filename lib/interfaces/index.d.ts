...
export interface CartGetters<CART, CARTITEM, FULFILLMENTGROUP, FULFILLMENTMETHOD> {
...
export interface ProductGetters<PRODUCT, PRODUCTVARIANT> {
    ...
    getDisplayPrice: (product: PRODUCT | PRODUCTVARIANT, currencyCode: string) => string;
    getPricing: (product: PRODUCT | PRODUCTVARIANT, currencyCode: string) => AgnosticPrice;
...
export interface CheckoutGetters<CART, FULFILLMENTGROUP, FULFILLMENTMETHOD, ORDERITEM> {
